...
export default function GuitarScene({ 
  ...
  floorAnimatedPosition,
  floorAnimatedRotation 
}) {
  ...
  return (
    <>
      ...
      <Guitar animatedPosition={guitarAnimatedPosition} animatedRotation={guitarAnimatedRotation}/>
      <Floor animatedPosition={floorAnimatedPosition} animatedRotation={floorAnimatedRotation}/>
