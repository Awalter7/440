  ...
  return (
    <>
      ...
      <Float intensity={.02} directions={{ x: true, y: true, z: false }}>
        <Guitar position={[-.7, 1.5, .3]} rotation={[.2, -Math.PI / 1.7, .6]}/>
        <DrumStand position={[.6, .8, .3]} rotation={[-Math.PI / .9, 0, -Math.PI / 9]} />
        <DrumKick position={[-.2, .8, .3]} rotation={[-Math.PI / 1.5, Math.PI / 1.3, -Math.PI / 5]}/>
