...
PLASMIC.registerComponent(CustomScroll, {
  ...
  props: {
    ...
    animateWords: {
      ...
      description: "Animate each word of the provided text",
      defaultValue: false,
        ...
        fields: {
          property: {
            ...
            options: [
              ...
              "opacity", "borderRadius", "scale", "rotate",
              "translateX", "translateY", "translateZ",
              "scaleX", "scaleY", "scaleZ",
              "rotateX", "rotateY", "rotateZ",
              "skewX", "skewY",
              "backgroundColor", "color", "fontSize", "letterSpacing",
              "lineHeight", "padding", "margin", "borderWidth",
      ...
      itemType: {
        ...
        fields: {
          ...
          dir: {
            ...
            description: "Direction the scroll animation plays.",
            defaultValue: "down",
          },
          delay: {
            type: "number",
    ...
    clickEffects: {
      type: "array",
      displayName: "Click Effects",
      description: "Define effects that trigger when specific elements are clicked",
    ...
    hoverEffects: {
      ...
      description: "Define effects that trigger on hover",
      ...
      itemType: {
        ...
        fields: {
          triggerId: {
            type: "string",
            displayName: "Trigger Element ID",
            description: "ID of the element that triggers this effect on hover",
            defaultValue: "",
          },
          fullCycle: {
            type: "boolean",
            displayName: "Full Cycle",
            description: "Should the animation reverse immediately after mouse exit.",
            defaultValue: true,
          },
          duration: {
            type: "number",
